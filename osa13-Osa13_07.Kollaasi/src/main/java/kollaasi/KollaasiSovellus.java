    ...
    public void start(Stage stage) {
        ...
        while (yKoordinaatti < korkeus) {
            ...
            while (xKoordinaatti < leveys) {
                ...
                if (xKoordinaatti < leveys / 2 && yKoordinaatti < korkeus / 2) {
                    vari = kuvanLukija.getColor(xKoordinaatti*2, yKoordinaatti*2);
                    punainen = vari.getRed();
                    vihrea = vari.getGreen();
                    sininen = vari.getBlue();
                    lapinakyvyys = vari.getOpacity();

                    uusiVari = new Color(punainen, vihrea, sininen, lapinakyvyys);
